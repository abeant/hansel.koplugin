...
- Libraries / shelves / magic shelves follow Grimmory Settings → View sidebar sort (`GET /api/v1/users/me`). Creation Date | Ascending is Library (id 1) then Classics (id 4). Genres uses Lucide `shapes`.
